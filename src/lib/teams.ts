...
export const teams: Team[] = [
  {
    ...
    image: '/img/committee-cover/booking.jpg',
    teamImage: '/img/committee-team/bookings-team.jpg',
    members: {
      executive: [
        {
          name: 'Payton Marino',
          position: '2025 - 2026 Booking Director',
          image: '/img/exec/payton.jpg',
        },
      ],
      general: [
        { name: 'Alberto Najera' },
  ...
  },
  {
    ...
    image: '/img/committee-cover/community.jpg',
    teamImage: '/img/committee-team/community-team.jpg',
      ...
      executive: [
        {
          ...
          image: '/img/exec/eleanor.jpg',
        },
        {
          name: 'Shreya Rallabandi',
          position: '2025 - 2026 Community Co-Director',
          image: '/img/exec/shreya.jpg',
        },
      ],
      general: [
        { name: 'Chelsea Cain' },
  ...
  },
  {
    ...
    image: '/img/committee-cover/corporate.jpg',
    teamImage: '/img/committee-team/corporate-team.jpg',
    members: {
      executive: [
        {
          name: 'Adam Valiji',
          position: '2025 - 2026 Corporate Director',
          image: '/img/exec/adam.jpg',
        },
        {
          name: 'Gio Cacciato',
          position: '2025 - 2026 Corporate Director',
          image: '/img/exec/gio.jpg',
        },
      ],
      general: [
  ...
  },
  {
    ...
    image: '/img/committee-cover/finance.jpg',
    teamImage: '/img/committee-team/finance-team.jpg',
    members: {
      executive: [
        {
          name: 'Roberto Borsetti',
          position: '2025 - 2026 Finance Co-Director',
          image: '/img/exec/roberto.jpg',
        },
        {
          name: 'Zander Sy',
          position: '2025 - 2026 Finance Co-Director',
          image: '/img/exec/zander.jpg',
        },
      ],
      general: [
  ...
  },
  {
    ...
    image: '/img/committee-cover/operations.jpg',
    teamImage: '/img/committee-team/operations-team.jpg',
    members: {
      executive: [
        {
          name: 'Brendan Howard',
          position: '2025 - 2026 Operations Co-Director',
          image: '/img/exec/brendan.jpg',
        },
        {
          name: 'Marina Shirky',
          position: '2025 - 2026 Operations Co-Director',
          image: '/img/exec/marina.jpg',
        },
      ],
      general: [
        { name: 'Adam Durr' },
  ...
  },
  {
    ...
    image: '/img/committee-cover/production.jpg',
    teamImage: '/img/committee-team/productions-team.jpg',
    members: {
      executive: [
        {
          name: 'Emma Brown',
          position: '2025 - 2026 Executive Producer',
          image: '/img/exec/emma.jpg',
        },
        {
          name: 'Keya Umesh',
          position: '2025 - 2026 Executive Producer',
          image: '/img/exec/keya.jpg',
        },
      ],
      general: [
        { name: 'Asha Buerk' },
  ...
  },
  {
    ...
    image: '/img/committee-cover/programming.jpg',
    teamImage: '/img/committee-team/programming-team.jpg',
  ...
  },
  {
    ...
    image: '/img/committee-cover/promotions.jpg',
    teamImage: '/img/committee-team/promotions-team.jpg',
    members: {
      executive: [
        {
          name: 'Alicia Gu',
          position: '2025 - 2026 Promotions Co-Director',
          image: '/img/exec/alicia.jpg',
        },
        {
          name: 'Lee Ekong',
          position: '2025 - 2026 Promotions Co-Director',
          image: '/img/exec/lee.jpg',
        },
      ],
      general: [
  ...
  },
  {
    ...
    image: '/img/committee-cover/tech.jpg',
    teamImage: '/img/committee-team/tech-team.jpg',
    members: {
      executive: [
        {
          name: 'David Fu',
          position: '2025 - 2026 Tech Co-Director',
          image: '/img/exec/david.jpg',
        },
        {
          name: 'Cate Rose',
          position: '2025 - 2026 Tech Co-Director',
          image: '/img/exec/cate.jpg',
        },
      ],
      general: [
        { name: 'Brock Brown' },
  ...
  },
  {
    ...
    image: '/img/committee-cover/general-board.jpg',
    teamImage: '/img/committee-team/gen-board-team.jpg',
    members: {
      executive: [
        {
          name: 'Ethan Sterling',
          position: 'Mayfest Co-Chair',
          image: '/img/exec/ethan.jpg',
        },
        {
          name: 'Felipe Reis Maccari',
          position: 'Mayfest Co-Chair',
          image: '/img/exec/felipe.jpg',
        },
      ],
      general: [
        { name: 'Abigail Chang' },
