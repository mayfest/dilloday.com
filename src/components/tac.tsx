  ...
  return (
    <div className="bg-black text-white max-w-4xl mx-auto my-5 p-8 shadow-lg">
      ...
      <p className="mb-4 text-[.1em]">
        ...
        right to remove individuals from the festival without a refund: * Dillo
        Day has a zero-tolerance policy for discrimination of any kind,
        including but not limited to discrimination on the basis of race, color,
        religion, sex, gender identity, sexual orientation, national origin,
        age, disability, or genetic information. Attendees determined to have
        engaged in discriminatory behavior face removal from the festival. *
        ...
        festival. * Damage, defacement, destruction, or theft of property,
        including but not limited to festival decor, golf carts, and stages is
        grounds to be immediately removed from the festival. All attendees are
        required to adhere to the University community standards guidelines
